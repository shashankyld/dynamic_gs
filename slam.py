...
if __name__ == "__main__":
    ...
    kNumLocalKFs = config.NumLocalKFs
    ...
    while True: 
        ...
        if dataset.isOk(): 
            ...
            if img is not None:
                ...
                if img_id == starting_img_id:
                    ...
                    tracking_status = slam.track_frame_to_keyframe(curr_frame, dynamic_mask=dynamic_mask)
        ...
        if img_id > ending_img_id:
            ...
            final_points = np.concatenate([pcd.points for pcd in accumulated_clouds.values()])
            final_colors = np.concatenate([pcd.colors for pcd in accumulated_clouds.values()])
